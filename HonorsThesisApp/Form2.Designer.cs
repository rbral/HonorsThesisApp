namespace HonorsThesisApp
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            addItemToDB = new Button();
            addBrandToDB = new Button();
            ...
            GB_StoreInfo.Controls.Add(addItemToDB);
            GB_StoreInfo.Controls.Add(addBrandToDB);
            ...
            // addItemToDB
            // 
            addItemToDB.Font = new Font("Segoe UI", 8.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            addItemToDB.Location = new Point(271, 189);
            addItemToDB.Margin = new Padding(1, 0, 1, 0);
            addItemToDB.Name = "addItemToDB";
            addItemToDB.Size = new Size(69, 23);
            addItemToDB.TabIndex = 19;
            addItemToDB.Text = "Add Item";
            ...
            // addBrandToDB
            // 
            addBrandToDB.Font = new Font("Segoe UI", 8.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            addBrandToDB.Location = new Point(271, 114);
            addBrandToDB.Margin = new Padding(1, 0, 1, 0);
            addBrandToDB.Name = "addBrandToDB";
            addBrandToDB.Size = new Size(69, 23);
            addBrandToDB.TabIndex = 18;
            addBrandToDB.Text = "Add Brand";
            addBrandToDB.UseVisualStyleBackColor = true;
            addBrandToDB.Visible = false;
            addBrandToDB.Click += addBrandToDB_Click;
            // 
            // TB_NewItemName
            // 
            ...
            // 
            button_addNewItemName.Location = new Point(271, 159);
            button_addNewItemName.Margin = new Padding(2, 1, 2, 1);
            button_addNewItemName.Name = "button_addNewItemName";
            button_addNewItemName.Size = new Size(69, 23);
            ...
            // button_addNewBrand
            // 
            button_addNewBrand.Location = new Point(271, 83);
            button_addNewBrand.Margin = new Padding(2, 1, 2, 1);
            button_addNewBrand.Name = "button_addNewBrand";
            button_addNewBrand.Size = new Size(69, 24);
